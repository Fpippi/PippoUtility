using PippoHelperException.Extension;
using System.Diagnostics.CodeAnalysis;
using System.Text.RegularExpressions;

namespace PippoHelperException
{
    public static class ExceptionPippo
    {
        [return: NotNull]
        public static T ThrowIfNull<T>([NotNull] T? o) => o ?? throw new InvalidOperationException();

        [return: NotNull]
        public static T ThrowIfNull<T>([NotNull] T? o) where T : struct => o ?? throw new InvalidOperationException();

        [return: NotNull]
        public static T ThrowIfNull<T>([NotNull] T? o, string exceptionMessage) => o ?? throw new InvalidOperationException(exceptionMessage);

        [return: NotNull]
        public static T ThrowIfNull<T, TException>([NotNull] T? o) where TException : Exception, new() => o ?? throw new TException();

        [return: NotNull]
        public static T ThrowIfNull<T, TException>([NotNull] T? o, string message) where TException : Exception, new() => o ?? throw (Activator.CreateInstance(typeof(TException), new object?[] { message }) as TException).ThrowIfNull();

        [return: NotNull]
        public static string ThrowIfNullOrEmpty([NotNull] string? o) => string.IsNullOrEmpty(o) ? throw new InvalidOperationException() : o;

        [return: NotNull]
        public static string ThrowIfNullOrEmpty([NotNull] string? o, string exceptionMessage) => string.IsNullOrEmpty(o) ? throw new InvalidOperationException(exceptionMessage) : o;

        [return: NotNull]
        public static string ThrowIfNullOrEmpty<TException>([NotNull] string? o) where TException : Exception, new() => string.IsNullOrEmpty(o) ? throw new TException() : o;

        [return: NotNull]
        public static string ThrowIsNullOrWhiteSpace([NotNull] string? o) => string.IsNullOrWhiteSpace(o) ? throw new InvalidOperationException() : o;

        [return: NotNull]
        public static string ThrowIsNullOrWhiteSpace([NotNull] string? o, string exceptionMessage) => string.IsNullOrWhiteSpace(o) ? throw new InvalidOperationException(exceptionMessage) : o;

        [return: NotNull]
        public static string ThrowIsNullOrWhiteSpace<TException>([NotNull] string? o) where TException : Exception, new() => string.IsNullOrWhiteSpace(o) ? throw new TException() : o;
